            ...
            <div className='detail space-y-3'>
              ...
              <div className='btns relative flex justify-between gap-3 pt-5'>
                <div className='normal-btn flex flex-wrap gap-3'>
                  <button className='flex w-fit items-center justify-center gap-2 rounded-lg bg-light-smoke px-5 py-2 text-medium font-medium leading-5 text-blue-darkBlue outline-none'>
                    <img src={dvlIcon} alt='' />
                    View on DVL Reader
                  </button>
                </div>
...
const Card = ({ url, title, range, viewOnText }) => {
  return (
    <div className='flex flex-col justify-between border-t px-3 py-5 md:flex-row md:px-10'>
      ...
      <div className='right flex flex-shrink-0 justify-between'>
        <button className='flex w-fit items-center justify-center gap-2 text-nowrap rounded-lg border border-light-magnolia px-3 py-2 text-medium font-medium leading-5 text-blue-darkBlue3 outline-none md:px-5'>
          <img src={dvlIcon} alt='' />
          {viewOnText}
        </button>
        <div className='icons flex items-center gap-2'>
